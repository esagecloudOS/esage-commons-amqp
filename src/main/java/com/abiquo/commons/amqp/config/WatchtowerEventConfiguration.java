...
public class WatchtowerEventConfiguration extends AMQPConfiguration
{
    private static final String WATCHTOWER_EXCHANGE = "watchtower.events";

    private static final String WATCHTOWER_ROUTING_KEY = "watchtower.events.event";
